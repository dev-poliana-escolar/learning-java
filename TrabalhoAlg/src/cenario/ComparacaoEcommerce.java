...
import static TrabalhoAlg.src.cenario.BucketEcommerce.bucketSort;
import static TrabalhoAlg.src.ordenacao.MetodosSort.quickSort;
import static TrabalhoAlg.src.vetor.GeraVetor.gerarPrecosEcommerce;

public class ComparacaoEcommerce {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            int[] vetor = gerarPrecosEcommerce(1000);
        ...
        for (int tamanho : tamanhos) {
            ...
            for (int r = 0; r < repeticoes; r++) {
                ...
                int[] original = gerarPrecosEcommerce(tamanho);
